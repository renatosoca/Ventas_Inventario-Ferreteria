...
public class frmVenta extends javax.swing.JInternalFrame {
    ...
    public frmVenta(JFrame frmPrincipal) {
        initComponents();
    ...
    private void crearDetalles(){
        ...
        public boolean isCellEditable(int fila, int columna){
            if (columna==4) {  // Habilitar edicion en las columnas establecidas
                return columna==4;
            }
            if (columna==5) {
                return columna==5;
        ...
        public Object getValueAt(int fila, int columna){
            if (columna==7) { // para que retorne en el SUBTOTAL
                Double cantD;
                try {
                    cantD=Double.parseDouble((String)getValueAt(fila, 4));
                } catch (Exception e) {
                    cantD=1.0;
                }
                Double precioD=Double.parseDouble((String)getValueAt(fila, 5));
                Double descuentoD=Double.parseDouble((String)getValueAt(fila, 6));
                if (cantD!=null && precioD!=null && descuentoD!=null) {
                    return String.format("%.2f",(cantD*precioD)-descuentoD).replace(",", "."); //PARA CONDICIONAR A SOLO 2 DECIMALES
        ...
        public void setValueAt(Object aValue, int fila, int columna){
            ...
            try {       //PARA VALIDAR EL STOCK 
                int cantD = Integer.parseInt((String)getValueAt(fila, 4));
                int StockD = Integer.parseInt((String)getValueAt(fila, 3));
                String nombreArticulo = (String)getValueAt(fila, 2);
                if (cantD>StockD) {
                    super.setValueAt(StockD, fila, 4);
                    mensajeError("La cantidad a vender no puede superar el stock. Se puede vender como máximo: "+StockD+" "+nombreArticulo);
                }
    ...
    private void ObtenerNumeroComprobante() {
        String tipoComprobante = (String)cbxTipoComprobante.getSelectedItem();
        String serieComprobante = this.control.GenerarUltimaSerieComprobante(tipoComprobante);
        String numComprobante = this.control.GenerarUltimoNroComprobante(tipoComprobante, serieComprobante);
        ...
        if (numComprobante.equals("")){
            ...
            txtNroComprobante.setText("000000"+Integer.toString(num));
        }        
    }
    ...
    private void initComponents() {
        ...
        btnSeleccionarArticulo.setText("ver");
                                ...
                                .addGroup(btnquitarLayout.createSequentialGroup()
                                    .addGroup(btnquitarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addGroup(btnquitarLayout.createSequentialGroup()
                                            ...
                                            .addGap(18, 18, 18)
                                            .addComponent(txtNombreCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addGroup(btnquitarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addGroup(btnquitarLayout.createSequentialGroup()
                                            .addGap(66, 66, 66)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        resp = this.control.insertar(Integer.parseInt(txtIdCliente.getText()),(String)cbxTipoComprobante.getSelectedItem(),txtSerieComprobante.getText(),txtNroComprobante.getText(),Double.parseDouble(txtImpuesto.getText()),Double.parseDouble(txtTotal.getText().replace(",", ".")),modeloDetalles);        
        if (resp.equals("OK")) {
        ...
        /*
    PARA ACTUALIZAR EL STOCK DEL ARTICULO LUEGO DE UNA VENTA
      CODIGO EN EL MySQL:
    ...
    */
    ...
    private void btnSeleccionarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarClienteActionPerformed
        frmSeleccionarClienteVenta frmSPC = new frmSeleccionarClienteVenta(contenedor, this, true);
        frmSPC.toFront();
    ...
    private void txtCodigoArticuloKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoArticuloKeyReleased
        if (txtCodigoArticulo.getText().length()>0) {
            if (evt.getKeyCode()==KeyEvent.VK_ENTER) {
                ...
                art=this.control.obtenerArticuloCodigoVenta(txtCodigoArticulo.getText());
                if (art==null) {
    ...
    private void btnVerVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerVentaActionPerformed
        if (tablaListado.getSelectedRowCount()==1) {
            ...
            txtIdCliente.setText(id_proveedor);
            txtNombreCliente.setText(nombre_proveedor);
    ...
    private void btnReporteComprobanteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteComprobanteActionPerformed
        if (tablaListado.getSelectedRowCount()==1) {
            ...
            this.mensajeError("Seleccione una venta para el reporte");
        }
