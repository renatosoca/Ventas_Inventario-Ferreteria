...
public class frmClientes extends javax.swing.JInternalFrame {
    ...
    private void listar(String texto, boolean paginar){
        ...
        if (paginar==true) {
            tablaListado.setModel(control.listarTipo(texto, totalPorPagina, numPagina,"Cliente"));
        }else{
            tablaListado.setModel(control.listarTipo(texto, totalPorPagina, 1,"Cliente"));
        }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (accion.equals("editar")) {
            ...
            resp=this.control.actualizar(Integer.parseInt(txtId.getText()), "Cliente",txtNombre.getText(),this.nombreAnterior , (String)cbxtipoDocumento.getSelectedItem(), txtnumeroDocumento.getText(),txtdireccion.getText(), txttelefono.getText(), txtemail.getText());
            if (resp.equals("OK")) {
            ...
            resp=this.control.insertar("Cliente", txtNombre.getText(), (String)cbxtipoDocumento.getSelectedItem(), txtnumeroDocumento.getText(),txtdireccion.getText(), txttelefono.getText(), txtemail.getText());
            if (resp.equals("OK")) {
