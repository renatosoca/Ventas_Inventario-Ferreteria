...
public class frmSeleccionarArticuloVenta extends javax.swing.JDialog {
    ...
    public frmSeleccionarArticuloVenta(java.awt.Frame parent,frmVenta frm, boolean modal) {
        ...
        this.setTitle("Seleccionar Articulos para la Venta");
    ...
    private void listar(String texto, boolean paginar){
        ...
        if (paginar==true) {
            tablaListado.setModel(control.listarArticuloVenta(texto, totalPorPagina, numPagina));
        }else{
            tablaListado.setModel(control.listarArticuloVenta(texto, totalPorPagina, 1));
        }
