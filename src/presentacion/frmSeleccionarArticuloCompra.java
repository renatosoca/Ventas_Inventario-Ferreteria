...
public class frmSeleccionarArticuloCompra extends javax.swing.JDialog {
    ...
    public frmSeleccionarArticuloCompra(java.awt.Frame parent,frmIngresoAlmacen frm, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.vista=frm;
        
        this.setTitle("Seleccionar Articulos para la Compra");
    ...
    private void initComponents() {
        ...
        btnSeleccionarArticulo.setText("Seleccionar Articulo");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(tabGeneral, javax.swing.GroupLayout.DEFAULT_SIZE, 906, Short.MAX_VALUE)
        );
    ...
    private void btnSeleccionarArticuloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarArticuloActionPerformed
        if (tablaListado.getSelectedRowCount()==1) {
            ...
            this.mensajeError("Debe Seleccionar el articulo que sea agregar al detalle");
        }
