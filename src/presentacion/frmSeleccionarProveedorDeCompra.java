 ...
 * @author rena_
 */
public class frmSeleccionarProveedorDeCompra extends javax.swing.JDialog {
    private frmIngresoAlmacen vista;
    ...
    public frmSeleccionarProveedorDeCompra(java.awt.Frame parent, frmIngresoAlmacen frm, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        this.setTitle("Seleccionar un Proveedor Para el Ingreso en Almacén");
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(tabGeneral, javax.swing.GroupLayout.DEFAULT_SIZE, 985, Short.MAX_VALUE)
        );
    ...
    private void btnSeleccionarProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarProveedorActionPerformed
        if (tablaListado.getSelectedRowCount()==1) {
            String id=String.valueOf(tablaListado.getValueAt(tablaListado.getSelectedRow(), 0));
            String nombre=String.valueOf(tablaListado.getValueAt(tablaListado.getSelectedRow(), 2));
            this.vista.txtCodigoProveedor.setText(id);
